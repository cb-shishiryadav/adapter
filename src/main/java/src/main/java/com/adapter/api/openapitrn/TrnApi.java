...
import com.adapter.model.openapitrn.TrnValidateBatchDeleteResponse;
import com.adapter.model.openapitrn.TrnValidateBatchRequest;
import com.adapter.model.openapitrn.TrnValidateBatchResponse;
import com.adapter.model.openapitrn.TrnValidateErrorResponse;
...
public interface TrnApi {
    ...
    default ResponseEntity<TrnValidateBatchDeleteResponse> deleteTrnValidateBatch(
    ...
    default ResponseEntity<TrnValidateResponse> fetchTrnValidate(
        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"trn\" : \"trn\", \"country\" : { \"code\" : \"code\", \"name\" : \"name\" }, \"validationDataSource\" : \"validationDataSource\", \"address\" : \"address\", \"requestId\" : \"requestId\", \"isBusiness\" : true, \"name\" : \"name\", \"externalId\" : \"externalId\", \"isRegistered\" : true, \"message\" : \"message\" }";
                    ApiUtil.setExampleResponse(request, "application/json", exampleString);
                    break;
                }
            }
    ...
    default ResponseEntity<TrnValidateBatchResponse> fetchTrnValidateBatch(
        @Parameter(name = "batchId", description = "The unique batch request identifier.", required = true, in = ParameterIn.PATH) @PathVariable("batchId") String batchId,
    ...
    default ResponseEntity<TrnValidateResponse> trnValidate(
    ...
    default ResponseEntity<TrnValidateBatchResponse> trnValidateBatch(
