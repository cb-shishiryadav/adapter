...
import com.adapter.model.openapilocationvalidation.BasicErrorResponse;
import com.adapter.model.openapilocationvalidation.HealthCheckResponse;
import com.adapter.model.openapilocationvalidation.LocationValidateErrorResponse;
import com.adapter.model.openapilocationvalidation.LocationValidateResponse;
import com.adapter.model.openapilocationvalidation.LocationValidationEvidence;
...
public interface ValidateLocationApi {
    ...
    default ResponseEntity<LocationValidateResponse> locationValidate(
        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"sourceCountry\" : \"sourceCountry\", \"evidenceOrigin\" : { \"address\" : \"address\", \"phone\" : \"phone\", \"bin\" : \"bin\", \"ip\" : \"ip\", \"taxRegistrationNumber\" : \"taxRegistrationNumber\", \"taxIdentifiers\" : \"taxIdentifiers\" } }";
